...
const Cart = ({ navigation }) => {
  ...
  let handleSnackBar = useCallback((message, visible) => {
    setMsg(message)
    setVisible(visible)
  },[visible])
  ...
  const handleOrderQty = useCallback(async (itemQty, index) => {
  ...
  return (
    <>
      <View style={{ height: 803 }}>
        <Header width={"70%"} navigation={navigation}  goback={e => { navigation.goBack() }} title="App" />
